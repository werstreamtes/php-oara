 ...
 * @category   BelboonWhitelabel
 * @copyright  Fubra Limited
 * @version    Release: 01.00
 *
 */
class BelboonWhitelabel extends \Oara\Network
{
    private $_api_key;
    private $_user_id;

    public function __construct($apiKey, $user_id, $BASE_PATH)
    {
        $this->_api_key = $apiKey;
        $this->_user_id = $user_id;
        //example: https://export.net.propelbon.com
    ...
    public function getVouchers()
    {
        ...
        $params = ['filter[uid]' => $this->_user_id];
